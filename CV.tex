...
\begin{rPresSection}{2025}{\textbf{Italian Political Science Association (SISP) 2025.} University of Naples – 4–6 September 2025.}
\end{rPresSection}\vspace{-0.2cm}
...
\begin{rPresSection}{2025}{\textbf{Collegio Carlo Alberto Days (CCA Days 2025).} \textit{When Valence Strategies Increase Polling Support: Evidence from Electoral Campaigns.} Collegio Carlo Alberto, Turin.}
\end{rPresSection}\vspace{-0.2cm}

\begin{rPresSection}{2025}{\textbf{MZES-DVPW Methods of Political Science Conference.} \textit{Investigating Political Scandals: Combining Conjoint Analysis and Audio-Based Experiments.} University of Mannheim (with A. Ceron \& G. M. Invernizzi).}
\end{rPresSection}\vspace{-0.2cm}
...
\begin{rPresSection}{2024}{\textbf{Italian Political Science Association (SISP) 2024.} University of Trieste – 12–14 September 2024.}
\end{rPresSection}\vspace{-0.2cm}

\begin{rPresSection}{2024}{\textbf{Collegio Carlo Alberto Days (CCA Days 2024).} \textit{Valence Theory and Political Scandals: A Proposal of a Conjoint Experiment.} Collegio Carlo Alberto, Turin.}
\end{rPresSection}\vspace{-0.2cm}
